...
newtype Nested a = Nested { nested :: Maybe a }
  deriving (Show, Eq, Ord, Generic, NFData, Semigroup, Monoid, Arbitrary, Functor, Foldable,
...
newtype Commented (comment :: Symbol) a = Commented { unCommented :: a }
  deriving (Show, Eq, Ord, Generic, NFData, Semigroup, Monoid, Arbitrary, Functor, Foldable, Traversable)
